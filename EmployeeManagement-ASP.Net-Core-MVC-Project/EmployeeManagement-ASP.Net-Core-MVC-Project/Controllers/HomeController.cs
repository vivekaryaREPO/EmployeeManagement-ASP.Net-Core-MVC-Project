...
{
    /*
    [Authorize]=> to be allowed to navigate to these url only when logged in. COuld be used on individual actions or controller
    ...
    */
    public class HomeController:Controller
    {
        ...
        */
        ...
        /*
         [AllowAnonymous] allows to navigate even if controller decorated with Authorize.
        If you use [AllowAnonymous] on controller and has any [Authorize] CAM, then 
        your Authorize decorator will be ignored and CAM will be allowed to be accessed.
         */
